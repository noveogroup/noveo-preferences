...
public class CustomObjectTest {
    ...
    private static final com.noveogroup.preferences.rx.mock.User DEFAULT_USER_VALUE = new com.noveogroup.preferences.rx.mock.User("default", 100);

    private NoveoRxPreferences noveoPreferencesWrapper;
    private com.noveogroup.preferences.rx.mock.TestSharedPreferences preferences;

    @Before
    public void before() {
        NoveoPreferences.setDebug(true);
        preferences = new com.noveogroup.preferences.rx.mock.TestSharedPreferences();
    ...
    public void object() {
        ...
        final RxPreference<com.noveogroup.preferences.rx.mock.User> userEntity = noveoPreferencesWrapper.getObject(KEY_USER, new com.noveogroup.preferences.rx.mock.UserStrategy(), DEFAULT_USER_VALUE);
        ...
        final com.noveogroup.preferences.rx.mock.User newUser = new com.noveogroup.preferences.rx.mock.User("new", -100);
